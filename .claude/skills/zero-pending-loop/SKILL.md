...
| `resume` | ogni iterazione del driver | seleziona un cluster — **o lavora quello che l'invocazione gli assegna con `--cluster Z-nnn`**, quando il driver gira con piu' lavoratori (#173) — lo porta a termine col protocollo, aggiorna piano e register, decide se continuare o chiudere | `references/selection.md` + `references/protocol.md` |
