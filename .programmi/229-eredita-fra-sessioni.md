...
- [ ] **F5 La prova sul vivo, e il ciclo chiuso** — una `close-propagate` reale deve lasciare **apertura + chiusura**, e un boot successivo deve dire «nessuna in sospeso». **fatto =** le due righe nel diario della stessa corsa, e l'esito letto dall'output, non dal codice
