...
- [ ] **F2 Riportare i verdetti nel piano** — **fatto =** le 49 caselle GIÀ-FATTO spuntate con il riferimento, i 10 SUPERATI marcati con la dottrina che li supera, `zp_state.py piano` che conta il residuo vero — da fare nella sessione che riprende `#76` (è una scrittura sul piano, non su questa verifica: si fa dopo averla riletta, non nella stessa corsa che l'ha prodotta)
