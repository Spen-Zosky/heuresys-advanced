...
| K-codice | stato | presa_da | presa_il | ultimo_passo_chiuso | prossimo_passo | migrazione_prenotata | evidenza | nota |
|---|---|---|---|---|---|---|---|---|
| R-1 | SOSPESA | S1104 | 2026-09-16T04:35+02:00 | 33 | 34 | 000420 | migrazione 000420 (prod+gemello, verificata); mandati.ts; cache-loader.ts filtrato; grantRole+revokeRole al mandato (2/~21 siti (b) di I-C); prova rossa-verde su revoked_at; verify_gate GREEN (evidenze/R1_verify_gate_run3.txt) | Passo 0 CHIUSO e verificato. Passo 34 (sostituzione dei siti — mandato: "un file per commit") INIZIATO ma non finito: 2 siti su ~21 (b) + 9 copie locali di I-F/I-C. Resta: skills/service.ts (6), gdpr/service.ts (2, verso haMandatoGdpr), skill-categories/skill-families/tenant-materialization (copie locali isPlatformAdmin), delegations/service.ts, auth/service.ts (2), process-kpi-templates/service.ts (2), content-blueprint-links copia locale — lista completa in esiti/I-C.md. Guardiano a fine sessione: ~68% contesto, sopra la soglia dei workflow (50%) ma sotto quella di chiusura (75%) |
