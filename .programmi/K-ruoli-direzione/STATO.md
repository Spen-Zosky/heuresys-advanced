...
| R-0 | CHIUSA | S1104 | 2026-09-16T23:56+02:00 | 38 |  | 000421 (applicata in produzione) | migrazione 000421 (VM, exit=0); esiti/R-0_porte.md, esiti/R-0.md; apps/api/src/lib/actor.ts (perimetroClienti/puoVedereCliente); test/unit/perimetro-clienti.unit.test.ts (6/6); baseline S-5 aggiornata (93 file); prova generale sul gemello VERDE (due passate, 51/51 sentinelle) | 12/24 porte collegate (tenants+update, tenant-import-runs, blueprint-activations, blueprint-overrides, provenance, generated-origins); 9 chiuse per costruzione (tenant-materialization, observability, tenant-blueprints — solo PLATFORM_ADMIN le raggiunge oggi, verificato sul vivo) rinviate a R-9/R-5; 3 (content-blueprint-links) fuori perimetro per ScopeFilter condiviso col modulo content — decisione tecnica di questa sessione, in esiti/R-0.md. Prova sul vivo del filtro di assegnazione rinviata a R-9 per costruzione del mandato (nessun ruolo popola ancora PLATFORM_ASSIGNED_MANDATE_ROLES) |
