...
Le sole voci che possono aspettare qui: D5 (alla chiusura di I-D), X-0 e K1-ADR (ratifica ADR), X-1 (righe dubbie), X-2 (mappa di sys_attendance), A0 (margine del pavimento del guardiano, mandato S1105), D10+ se nasce.
