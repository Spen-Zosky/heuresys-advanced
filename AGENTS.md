...
- **Durable rules / architecture** → this file (`AGENTS.md`).
...
- **A red CI is an error Codex MUST fix** (R3), never hand back to the user — consult `gh run list`/`gh run watch` as evidence (R23/e).
