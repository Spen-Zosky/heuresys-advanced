...
import { jobOffersRoutes } from "./modules/job-offers/routes.js";
...
import { platformTenantAssignmentsRoutes } from "./modules/platform-tenant-assignments/routes.js";
...
import { performanceReviewsRoutes } from "./modules/performance-reviews/routes.js";
import { calibrationSessionsRoutes } from "./modules/calibration-sessions/routes.js";
...
import { publicJobPostingsRoutes } from "./modules/public-job-postings/routes.js";
...
export async function buildApp(options: BuildAppOptions = {}): Promise<FastifyInstance> {
  ...
  await app.register(jobOffersRoutes, { prefix: "/v1/job-offers" });
  ...
  await app.register(platformTenantAssignmentsRoutes, { prefix: "/v1/platform-tenant-assignments" });
  ...
  await app.register(performanceReviewsRoutes, { prefix: "/v1/performance-reviews" }); // #92 passo 3/7
  await app.register(calibrationSessionsRoutes, { prefix: "/v1/calibration-sessions" }); // #92 passo 3/7
  ...
  await app.register(publicJobPostingsRoutes, { prefix: "/v1/public" });
