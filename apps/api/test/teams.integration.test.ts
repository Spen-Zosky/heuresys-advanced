 ...
 *   · antonio.parisi (TEAM_MEMBER of DIV-CFO) · platform-test-admin@collaudo.invalid (PLATFORM_ADMIN).
 */
...
describe("/v1/teams/* + /v1/me/team integration (WS-4 R1b)", () => {
  beforeAll(async () => {
    ...
    adminS = await login(suite, "platform-test-admin@collaudo.invalid");
