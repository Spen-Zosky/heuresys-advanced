 ...
 *
 * Source of truth React port of the HTML prototype:
 *   ux-design/prototypes/superuser-system-health.html
 *
 * Composed entirely from @heuresys/ui dashboard pattern components.
 * Demonstrates the full 20-pattern set ratified as brand default
 * (commit feat(brand): promote SUPERUSER prototype patterns to bundle default).
 *
 * Specs:
