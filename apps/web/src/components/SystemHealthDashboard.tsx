 ...
 * Reason: this file is consumed by both apps/web AND apps/showcase (via
 * sync-showcase.sh). apps/showcase doesn't have lucide-react in its package.json,
 * and the static-export GitHub Pages build failed on `Can't resolve 'lucide-react'`.
 * Inlining keeps the component portable.
 */
const ICON_CLS = "h-4 w-4 shrink-0";
function SvgBase({ children, className = ICON_CLS, strokeWidth = 2 }: { children: React.ReactNode; className?: string; strokeWidth?: number }) {
  return (
...
const Activity     = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></SvgBase>;
const Layers       = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></SvgBase>;
const ScrollText   = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></SvgBase>;
const ShieldCheck  = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><path d="M9 12l2 2 4-4"/><path d="M21 12c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9-9c.83 0 1.64.12 2.41.33"/><path d="M22 4L12 14"/></SvgBase>;
const Users        = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></SvgBase>;
const Lock         = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></SvgBase>;
const Database     = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></SvgBase>;
const Settings     = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></SvgBase>;
const AlertCircle  = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></SvgBase>;
const Code2        = ({ className = ICON_CLS }: { className?: string }) => <SvgBase className={className}><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></SvgBase>;
