...
- **Counts verified (real count(\*), post-ANALYZE 2026-06-01)**: **sys_users 161**, **positions 162**, **org_units 26**, **assignments 160 PRIMARY**, **2 tenant ACTIVE** (RTL_BANK 158 + HEURESYS 3 — case-study scope), **sys.* populated 65/134**. Lineage: **69.450** rows. Brownfield registry: 93 source_tables, 1164 source_columns, 94 table_mappings, **1271 column_mappings**, 18 staging.wave1_*, tenant_id_mappings 2 (in-scope). import_runs: 21 COMPLETED + 1 CANCELLED + 1 FAILED. **46 migration** (000047 = case-study cleanup).
