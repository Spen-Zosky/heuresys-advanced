...
> ⚠️ **Anomalia rilevata (non risolta, fuori scope S954)**: **3 tenant ACTIVE** non 2 — oltre a RTL_BANK (158 utenti) + HEURESYS (3), esiste ancora `RTL_BANK_REFERENCE` "Retail Bank Reference" **ACTIVE con 0 utenti** (residuo non collassato dal P1 RTL-stabilization). Candidato cleanup/archive in una sessione dedicata.
