...
- **55 file migration** idempotenti `000001..000056` (**gap `000035` cosmetico**, documentato). Ultime: `000051` skill_categories nullable FK (ADR-0025) · `000052` activity-class kind constant · `000053` `sys_user_preferences` (P1) · `000054` teams/roles (R1b) · `000055` team UI interface · **`000056` reclassify activity_classification_mappings card IMPORT→REFERENCE_ONLY (S958, ADR-0025 §5.4 — WS-3 blocker resolved)**. Contract: `pnpm db:migrate` ×2 → pg_dump diff vuoto + `db:validate` 7/7 (verificato S957; 000056 idempotente ×2 S958).
