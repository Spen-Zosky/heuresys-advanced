# PERCHE_LE_REGOLE — CLAUDE.md fino al 2026-09-26

Questo è il testo integrale di `CLAUDE.md` così com'era prima della riscrittura del 2026-09-26 (mandato `REGOLE`). È conservato per i racconti dei casi che hanno generato le regole oggi snellite nel CLAUDE.md attuale — non è più la fonte dei vincoli del progetto.
