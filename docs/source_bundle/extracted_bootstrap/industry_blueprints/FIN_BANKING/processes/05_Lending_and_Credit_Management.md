...
## Process: Retail and SME Lending

---

# 1. Process Overview

The Retail and SME Lending process manages the end-to-end credit lifecycle for retail and SME customers, including application intake, document collection, affordability checks, credit scoring, collateral evaluation, approval, disbursement, servicing, monitoring, restructuring, collection, and NPL management.
...
### Activities
- Define, execute, monitor, and improve all activities related to loan origination.
...
### Activities
- Define, execute, monitor, and improve all activities related to credit assessment.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.3 Approval and Delegation
### Activities
- Define, execute, monitor, and improve all activities related to approval and delegation.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.4 Contracting and Disbursement
### Activities
- Define, execute, monitor, and improve all activities related to contracting and disbursement.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.5 Loan Servicing
### Activities
- Define, execute, monitor, and improve all activities related to loan servicing.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.6 Early Warning
### Activities
- Define, execute, monitor, and improve all activities related to early warning.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.7 Collections and NPL
### Activities
- Define, execute, monitor, and improve all activities related to collections and npl.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
| Entity | Description |
| --- | --- |
| Loan Application | Primary information object used by the Retail and SME Lending process. |
| Borrower Profile | Primary information object used by the Retail and SME Lending process. |
| Credit Score | Primary information object used by the Retail and SME Lending process. |
| Collateral | Primary information object used by the Retail and SME Lending process. |
| Guarantee | Primary information object used by the Retail and SME Lending process. |
| Loan Contract | Primary information object used by the Retail and SME Lending process. |
| Repayment Plan | Primary information object used by the Retail and SME Lending process. |
| Delinquency Case | Primary information object used by the Retail and SME Lending process. |
| NPL File | Primary information object used by the Retail and SME Lending process. |
...
- AML checks on borrowers and funds
- Supervisory credit reporting
