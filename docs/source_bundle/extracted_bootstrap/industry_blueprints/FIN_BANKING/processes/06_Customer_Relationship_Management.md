...
## Process: Customer Lifecycle, Service and Engagement

---

# 1. Process Overview

The Customer Lifecycle, Service and Engagement process orchestrates customer acquisition, onboarding support, segmentation, portfolio management, service requests, complaint handling, retention, and relationship development across branches, contact center, web, mobile, and relationship managers.
...
- Credit approval decisioning
- Core IT incident resolution
...
### Activities
- Define, execute, monitor, and improve all activities related to customer onboarding.
...
## 4.2 Segmentation
### Activities
- Define, execute, monitor, and improve all activities related to segmentation.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to relationship management.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to service requests.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to complaint management.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.6 Retention and Loyalty
### Activities
- Define, execute, monitor, and improve all activities related to retention and loyalty.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
| Entity | Description |
| --- | --- |
| Customer Profile | Primary information object used by the Customer Lifecycle, Service and Engagement process. |
| Interaction | Primary information object used by the Customer Lifecycle, Service and Engagement process. |
| Service Request | Primary information object used by the Customer Lifecycle, Service and Engagement process. |
| Complaint | Primary information object used by the Customer Lifecycle, Service and Engagement process. |
| Segment | Primary information object used by the Customer Lifecycle, Service and Engagement process. |
| Campaign | Primary information object used by the Customer Lifecycle, Service and Engagement process. |
| Opportunity | Primary information object used by the Customer Lifecycle, Service and Engagement process. |
| Consent | Primary information object used by the Customer Lifecycle, Service and Engagement process. |
