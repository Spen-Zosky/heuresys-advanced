# Compliance, AML & Regulatory Processes
## Process: Compliance, KYC, AML and Supervisory Reporting

---

# 1. Process Overview

The Compliance, KYC, AML and Supervisory Reporting process ensures that the bank operates within applicable banking, AML, privacy, conduct, consumer-protection, and supervisory requirements through policies, controls, monitoring, investigations, regulatory reporting, and audit-ready evidence.
...
## 4.1 KYC Governance
### Activities
- Define, execute, monitor, and improve all activities related to kyc governance.
...
## 4.2 AML Monitoring
### Activities
- Define, execute, monitor, and improve all activities related to aml monitoring.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to sanctions screening.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to compliance testing.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to regulatory reporting.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.6 Policy and Control Management
### Activities
- Define, execute, monitor, and improve all activities related to policy and control management.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
| Entity | Description |
| --- | --- |
| KYC Profile | Primary information object used by the Compliance, KYC, AML and Supervisory Reporting process. |
| AML Alert | Primary information object used by the Compliance, KYC, AML and Supervisory Reporting process. |
| Sanctions Hit | Primary information object used by the Compliance, KYC, AML and Supervisory Reporting process. |
| Compliance Finding | Primary information object used by the Compliance, KYC, AML and Supervisory Reporting process. |
| Regulatory Report | Primary information object used by the Compliance, KYC, AML and Supervisory Reporting process. |
| Policy | Primary information object used by the Compliance, KYC, AML and Supervisory Reporting process. |
| Control Test | Primary information object used by the Compliance, KYC, AML and Supervisory Reporting process. |
| Evidence File | Primary information object used by the Compliance, KYC, AML and Supervisory Reporting process. |
...
- AML directives and local rules
...
- Document intelligence for KYC refresh
- Automated regulatory data quality checks
