...
## Process: Digital and Omnichannel Banking

---

# 1. Process Overview

The Digital and Omnichannel Banking process manages customer access and service delivery through mobile banking, web banking, API banking, ATM/self-service, contact center, and omnichannel journeys.
...
## 4.1 Digital Access
### Activities
- Define, execute, monitor, and improve all activities related to digital access.
...
## 4.2 Authentication and SCA
### Activities
- Define, execute, monitor, and improve all activities related to authentication and sca.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.3 Digital Service Execution
### Activities
- Define, execute, monitor, and improve all activities related to digital service execution.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.4 Omnichannel Handover
### Activities
- Define, execute, monitor, and improve all activities related to omnichannel handover.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.5 API Banking
### Activities
- Define, execute, monitor, and improve all activities related to api banking.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.6 Digital Support
### Activities
- Define, execute, monitor, and improve all activities related to digital support.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
| Entity | Description |
| --- | --- |
| Digital User | Primary information object used by the Digital and Omnichannel Banking process. |
| Device | Primary information object used by the Digital and Omnichannel Banking process. |
| Session | Primary information object used by the Digital and Omnichannel Banking process. |
| Authentication Event | Primary information object used by the Digital and Omnichannel Banking process. |
| Digital Service Request | Primary information object used by the Digital and Omnichannel Banking process. |
| API Consent | Primary information object used by the Digital and Omnichannel Banking process. |
| Channel Incident | Primary information object used by the Digital and Omnichannel Banking process. |
...
- AI-based support triage
- Personalized digital nudges
