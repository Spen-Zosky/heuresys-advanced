...
## Process: Retail and SME Commercial Development

---

# 1. Process Overview

The Retail and SME Commercial Development process drives commercial planning, lead generation, advisory, campaigns, product propositions, branch portfolio development, SME relationship management, and partner-based distribution.
...
## Excluded Activities
- Credit final approval
- AML investigation
- Core banking technical operations

---

# 4. Core Process Domains

## 4.1 Commercial Planning
### Activities
- Define, execute, monitor, and improve all activities related to commercial planning.
...
## 4.2 Lead Management
### Activities
- Define, execute, monitor, and improve all activities related to lead management.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.3 Advisory and Proposal
### Activities
- Define, execute, monitor, and improve all activities related to advisory and proposal.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to campaign execution.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.5 Relationship Reviews
### Activities
- Define, execute, monitor, and improve all activities related to relationship reviews.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.6 Partner Sales
### Activities
- Define, execute, monitor, and improve all activities related to partner sales.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
| Entity | Description |
| --- | --- |
| Lead | Primary information object used by the Retail and SME Commercial Development process. |
| Opportunity | Primary information object used by the Retail and SME Commercial Development process. |
| Customer Portfolio | Primary information object used by the Retail and SME Commercial Development process. |
| Product Offer | Primary information object used by the Retail and SME Commercial Development process. |
| Campaign | Primary information object used by the Retail and SME Commercial Development process. |
| Commercial Interaction | Primary information object used by the Retail and SME Commercial Development process. |
| Sales Target | Primary information object used by the Retail and SME Commercial Development process. |
...
- Marketing consent
- Complaint and mis-selling controls
