# Legal & Litigation
## Process: Legal Advisory, Contracts and Litigation Management

---

# 1. Process Overview

The Legal Advisory, Contracts and Litigation Management process provides legal support for contracts, disputes, collections litigation, regulatory interpretation, governance documentation, customer claims, supplier agreements, and court-related matters.
...
## 4.1 Legal Intake
### Activities
- Define, execute, monitor, and improve all activities related to legal intake.
...
## 4.2 Contract Review
### Activities
- Define, execute, monitor, and improve all activities related to contract review.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.3 Litigation Case Management
### Activities
- Define, execute, monitor, and improve all activities related to litigation case management.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.4 Judicial Collections
### Activities
- Define, execute, monitor, and improve all activities related to judicial collections.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.5 Legal Opinions
### Activities
- Define, execute, monitor, and improve all activities related to legal opinions.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.6 Governance Support
### Activities
- Define, execute, monitor, and improve all activities related to governance support.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
| Entity | Description |
| --- | --- |
| Legal Case | Primary information object used by the Legal Advisory, Contracts and Litigation Management process. |
| Contract | Primary information object used by the Legal Advisory, Contracts and Litigation Management process. |
| Legal Opinion | Primary information object used by the Legal Advisory, Contracts and Litigation Management process. |
| Court Deadline | Primary information object used by the Legal Advisory, Contracts and Litigation Management process. |
| Claim | Primary information object used by the Legal Advisory, Contracts and Litigation Management process. |
| External Counsel | Primary information object used by the Legal Advisory, Contracts and Litigation Management process. |
| Legal Risk Assessment | Primary information object used by the Legal Advisory, Contracts and Litigation Management process. |
...
- Civil and banking law requirements
- Consumer claims rules
- Evidence retention
- Court deadlines
- Confidentiality and legal privilege
- Outsourcing legal controls
