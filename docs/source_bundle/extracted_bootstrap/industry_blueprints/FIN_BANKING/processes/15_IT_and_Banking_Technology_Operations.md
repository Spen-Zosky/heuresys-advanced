# IT & Banking Technology Operations
## Process: Core Banking, ITSM, Cybersecurity and Data Operations

---

# 1. Process Overview

The Core Banking, ITSM, Cybersecurity and Data Operations process ensures reliable operation of core banking platforms, integration services, infrastructure, cybersecurity, identity management, service desk, change management, data pipelines, and technology continuity.
...
### Activities
- Define, execute, monitor, and improve all activities related to core banking operations.
...
## 4.2 ITSM
### Activities
- Define, execute, monitor, and improve all activities related to itsm.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.3 Change and Release
### Activities
- Define, execute, monitor, and improve all activities related to change and release.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.4 Cybersecurity
### Activities
- Define, execute, monitor, and improve all activities related to cybersecurity.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.5 IAM
### Activities
- Define, execute, monitor, and improve all activities related to iam.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.6 Data and Integration
### Activities
- Define, execute, monitor, and improve all activities related to data and integration.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.7 Batch and Job Monitoring
### Activities
- Define, execute, monitor, and improve all activities related to batch and job monitoring.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
| Entity | Description |
| --- | --- |
| Application | Primary information object used by the Core Banking, ITSM, Cybersecurity and Data Operations process. |
| Incident | Primary information object used by the Core Banking, ITSM, Cybersecurity and Data Operations process. |
| Change Request | Primary information object used by the Core Banking, ITSM, Cybersecurity and Data Operations process. |
| Service Request | Primary information object used by the Core Banking, ITSM, Cybersecurity and Data Operations process. |
| User Identity | Primary information object used by the Core Banking, ITSM, Cybersecurity and Data Operations process. |
| Access Right | Primary information object used by the Core Banking, ITSM, Cybersecurity and Data Operations process. |
| Interface | Primary information object used by the Core Banking, ITSM, Cybersecurity and Data Operations process. |
| Batch Job | Primary information object used by the Core Banking, ITSM, Cybersecurity and Data Operations process. |
| Security Event | Primary information object used by the Core Banking, ITSM, Cybersecurity and Data Operations process. |
