...
## Process: Operational Resilience, Fraud Prevention and Physical Security

---

# 1. Process Overview

The Operational Resilience, Fraud Prevention and Physical Security process protects continuity of critical banking services through business continuity planning, disaster recovery, crisis management, fraud prevention, physical security, incident response, and post-incident review.
...
- Normal commercial campaign execution
- Standard accounting closing
...
### Activities
- Define, execute, monitor, and improve all activities related to business continuity.
...
### Activities
- Define, execute, monitor, and improve all activities related to disaster recovery.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to crisis management.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to fraud prevention.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
### Activities
- Define, execute, monitor, and improve all activities related to physical security.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
## 4.6 Operational Resilience Testing
### Activities
- Define, execute, monitor, and improve all activities related to operational resilience testing.
- Manage required inputs, outputs, approvals, controls, escalations, and evidence.
- Coordinate front-office, back-office, risk, compliance, finance, IT, and external stakeholders where applicable.
...
| Entity | Description |
| --- | --- |
| Critical Service | Primary information object used by the Operational Resilience, Fraud Prevention and Physical Security process. |
| BCP Plan | Primary information object used by the Operational Resilience, Fraud Prevention and Physical Security process. |
| DR Test | Primary information object used by the Operational Resilience, Fraud Prevention and Physical Security process. |
| Incident | Primary information object used by the Operational Resilience, Fraud Prevention and Physical Security process. |
| Fraud Case | Primary information object used by the Operational Resilience, Fraud Prevention and Physical Security process. |
| Security Event | Primary information object used by the Operational Resilience, Fraud Prevention and Physical Security process. |
| Recovery Action | Primary information object used by the Operational Resilience, Fraud Prevention and Physical Security process. |
| Post-Incident Review | Primary information object used by the Operational Resilience, Fraud Prevention and Physical Security process. |
...
- Data protection in incidents
- Board/committee escalation procedures
...
- Predictive resilience indicators
