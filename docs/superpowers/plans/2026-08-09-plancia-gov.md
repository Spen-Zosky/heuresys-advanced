...
| **P6** | Configurazione completa, **sempre verificata** | io | ogni campo della config modificabile dalla plancia, e ogni applicazione ripassa dalla verifica, che può dire di no | **da fare** — unica voce non chiusa |
