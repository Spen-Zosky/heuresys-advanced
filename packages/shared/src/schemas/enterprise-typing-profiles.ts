...
export const EnterpriseTypingProfileSchema = z.object({
  enterpriseTypingProfileId: z.string().uuid(),
  tenantId: z.string().uuid(),
  industryClassId: z.string().uuid().nullable(),
  sizeBandId: z.string().uuid().nullable(),
  operatingModelId: z.string().uuid().nullable(),
...
export const EnterpriseTypingProfileListQuerySchema = z.object({
  ...
  industryClassId: z.string().uuid().optional(),
...
export const UpsertEnterpriseTypingProfileBodySchema = z.object({
  ...
  industryClassId: z.string().uuid().nullable().optional(),
  sizeBandId: z.string().uuid().nullable().optional(),
  operatingModelId: z.string().uuid().nullable().optional(),
...
export const EnterpriseTypingProfileIdParamSchema = z.object({ id: z.string().uuid() });
